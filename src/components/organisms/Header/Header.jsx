  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 bg-neutral-900 shadow-lg">
      <nav className="max-w-7xl mx-auto px-6">
        {/* Мобільний header для екранів < 768px */}
        ...
        <div className="header-desktop items-center py-4 min-h-60px gap-6 lg-gap-8 xl-gap-10">
        ...
        {/* Планшетний header для екранів 768-1023px */}
        <div className="header-tablet flex-col py-2">
          
          {/* Перший ряд - лого та навігація */}
          ...
          {/* Другий ряд - перемикач, контакти, соцмережі (праворуч) */}
        ...
        {/* Mobile Menu - показується тільки на мобільних коли відкрите */}
        {isMobileMenuOpen && (
